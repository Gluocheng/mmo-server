...
func (x *EnterGameRequest) GetPlayerId() int64 {
	if x != nil {
		return x.PlayerId
	}
	return 0
...
func (x *EnterGameRequest) GetSceneId() int32 {
	if x != nil {
		return x.SceneId
	}
	return 0
...
type EnterGameResponse struct {
	...
	Players []int64 `protobuf:"varint,2,rep,packed,name=players,proto3" json:"players,omitempty"`
}
...
func (x *EnterGameResponse) GetSceneId() int32 {
	if x != nil {
		return x.SceneId
	}
	return 0
...
func (x *EnterGameResponse) GetPlayers() []int64 {
	if x != nil {
		return x.Players
	}
	return nil
...
func (x *MoveBroadcast) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *MoveBroadcast) GetZ() float32 {
	if x != nil {
		return x.Z
	}
	return 0
...
var file_scene_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x6d,
	0x6d, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x76, 0x31, 0x22, 0x4a,
	...
	0x05, 0x52, 0x07, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x49, 0x64, 0x22, 0x48, 0x0a, 0x11, 0x45, 0x6e,
	...
	0x05, 0x52, 0x07, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x6c,
	0x61, 0x79, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x03, 0x52, 0x07, 0x70, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x73, 0x22, 0x37, 0x0a, 0x0b, 0x4d, 0x6f, 0x76, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x0c, 0x0a, 0x01, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01,
	0x78, 0x12, 0x0c, 0x0a, 0x01, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01, 0x79, 0x12,
	0x0c, 0x0a, 0x01, 0x7a, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01, 0x7a, 0x22, 0x4b, 0x0a,
	0x0d, 0x4d, 0x6f, 0x76, 0x65, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x12, 0x10,
	...
	0x7a, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01, 0x7a, 0x42, 0x42, 0x5a, 0x40, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
	0x2f, 0x6d, 0x6d, 0x6f, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x69, 0x6e, 0x74, 0x65,
	0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x70, 0x62, 0x2f,
	0x67, 0x65, 0x6e, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x70, 0x62, 0x62, 0x06,
...
var file_scene_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_scene_proto_goTypes = []interface{}{
	(*EnterGameRequest)(nil),  // 0: mmo.protocol.v1.EnterGameRequest
	(*EnterGameResponse)(nil), // 1: mmo.protocol.v1.EnterGameResponse
	(*MoveRequest)(nil),       // 2: mmo.protocol.v1.MoveRequest
	(*MoveBroadcast)(nil),     // 3: mmo.protocol.v1.MoveBroadcast
}
